...
@Route(value = ApprovementIllView.ROUTE, layout = MainLayout.class)
@Authorize(Permission.APPROVEMENT_ILL_VIEW)
public class ApprovementIllView extends AppView implements HasUrlParameter<String> {

    public static final String ROUTE = "approvement-ill-list";
    ...
    public ApprovementIllView(AppEnv appEnv, ApprovementComponentOperation approvementComponentOperation,
    ...
    private void initView(String params){
        ...
        approvementCardComponent = new ApprovementCardComponent(appEnv, approvementComponentOperation,
                entityNewComponentOperation, listService, holidayService,
                getHistoryBreadcrumbs(), getFilterAction(), ApprovementType.ILL,
                params, Permission.APPROVEMENT_ILL_VIEW, roleService, ROUTE, enumerationComponentOperation);
