...
@Route(value = ApprovementUnpaidLeaveView.ROUTE, layout = MainLayout.class)
@Authorize(Permission.APPROVEMENT_UNPAID_LEAVE_VIEW)
public class ApprovementUnpaidLeaveView extends AppView implements HasUrlParameter<String> {
    public static final String ROUTE = "approvement-unpaid-leave-list";
    ...
    public ApprovementUnpaidLeaveView(AppEnv appEnv, ApprovementComponentOperation approvementComponentOperation,
    ...
    private void initView(String params) {
        ...
        approvementCardComponent = new ApprovementCardComponent(appEnv, approvementComponentOperation,
                ...
                ApprovementType.UNPAID_LEAVE, params, Permission.APPROVEMENT_UNPAID_LEAVE_VIEW, roleService, ROUTE,
