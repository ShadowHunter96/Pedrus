 ...
 * the License.
 */
package cz.bbn.cerberus.commons.component.ui.menubar;
 ...
 * @author Vaadin Ltd
 */
@Tag("project-vaadin-menu-bar")
@NpmPackage(value = "@vaadin/polymer-legacy-adapter", version = "23.1.1")
@JsModule("@vaadin/polymer-legacy-adapter/style-modules.js")
@JsModule("./menubarConnector.js")
@JsModule("./menu-bar/src/vaadin-menu-bar.js")
public class MenuBar extends Component
        implements HasMenuItems, HasSize, HasStyle, HasTheme, HasEnabled {

    private final MenuManager<MenuBar, MenuItem, SubMenu> menuManager;
    private final MenuItemsArrayGenerator<MenuItem> menuItemsArrayGenerator;
     ...
     * use {@link MenuItem#getSubMenu()}.
     *
     * @param component the component to add inside new item
     * @return the added {@link MenuItem} component
     */
     ...
     * use {@link MenuItem#getSubMenu()}.
     *
     * @param component     the component to add inside the added menu item
     * @param clickListener the handler for clicking the new item, can be {@code null} to
     *                      not add listener
     * @return the added {@link MenuItem} component
     */
     ...
     *
     * @param items the item components to remove, not {@code null}
     * @throws IllegalArgumentException if any of the item components to remove is not a child of
     *                                  this menu bar
     */
     ...
     *
     * @param openOnHover {@code true} to make the sub menus open on hover (mouseover),
    ...
    public void addThemeVariants(MenuBarVariant... variants) {
        getThemeNames()
                .addAll(Stream.of(variants).map(MenuBarVariant::getVariantName).toList());
    }
    ...
    public void removeThemeVariants(MenuBarVariant... variants) {
        getThemeNames().removeAll(
                Stream.of(variants).map(MenuBarVariant::getVariantName).toList());
    }
    ...
    public static class MenuBarI18n implements Serializable {
         ...
         * accessible.
         *
         * @param moreOptions the overflow button aria-label
