...
public class ContractSupplierTab extends TabSimpleComponent {
    ...
    public ContractSupplierTab(SubjectComponentOperation subjectComponentOperation, String objectId,
    ...
    private void initTab() {
        ...
        grid = new SubjectGridComponent(
                subjectComponentOperation.getDeleteActionSubjectByObject(objectId, ObjectType.CONTRACT),
                subjectComponentOperation.getItemActionSubjectByObjectPage(objectId, ObjectType.CONTRACT),
