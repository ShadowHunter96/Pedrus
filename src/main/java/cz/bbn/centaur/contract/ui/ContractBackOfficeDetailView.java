...
@Route(value = ContractBackOfficeDetailView.ROUTE, layout = MainLayout.class)
@Authorize(Permission.BO_CONTRACT_VIEW)
@Slf4j
public class ContractBackOfficeDetailView extends AppView implements HasUrlParameter<String>, CustomPermissionSingleListener {

    public static final String ROUTE = "bo-contract-detail";
    ...
    public ContractBackOfficeDetailView(ContractService contractService, AppEnv appEnv,
    ...
    private void initView() {
        ...
        tabEntryList.add(new TabEntry(Transl.get("Connected contracts"), new ContractConnectedContractTab(
                contractComponentOperation.getConnectedContractItemAction(
                        dto.getId(), ContractInternalType.OPERATIONAL), appEnv)));
