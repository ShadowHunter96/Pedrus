...
public class ContactPersonDocumentTab extends TabSimpleComponent {

    private final DocumentComponentOperation documentComponentOperation;
    private final ContactPersonDto dto;
    ...
    public ContactPersonDocumentTab(DocumentComponentOperation documentComponentOperation, ContactPersonDto dto,
    ...
    private void initTab() {
        ...
        documentComponent = new DocumentComponent(
                ...
                DocumentObjectEnum.CONTACT_PERSON, Permission.CONTACT_PERSON_DOCUMENT_UPLOAD,
                Permission.CONTACT_PERSON_DOCUMENT_DOWNLOAD, Permission.CONTACT_PERSON_DOCUMENT_DELETE,
                hasCustomPermission, addDocument, listService);
        this.setSizeFull();
