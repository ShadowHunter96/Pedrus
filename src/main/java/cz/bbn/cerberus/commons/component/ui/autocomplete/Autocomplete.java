package cz.bbn.cerberus.commons.component.ui.autocomplete;
 ...
 * @author Vaadin Ltd
 */
@Tag("vcf-autocomplete-app")
@JsModule("./vcf-autocomplete/src/vcf-autocomplete.js")
public class Autocomplete extends
        PolymerTemplate<Autocomplete.AutocompleteTemplateModel> implements
        HasTheme, HasSize, HasValue<Autocomplete.AutocompleteValueAppliedEvent, String>,
    ...
    public Autocomplete(int limit, int timeout, String label) {
        this();
        setLimit(limit);
    ...
    public Registration addValueChangeListener(
        ...
        return addAutocompleteValueAppliedListener(event -> listener.valueChanged(event));
    }
