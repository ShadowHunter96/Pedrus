...
public class ContractBackOfficeDetailComponent extends VerticalLayout {
    ...
    public ContractBackOfficeDetailComponent(ContractDto dto, List<ContractDto> contractList, List<UserDto> userList,
        ...
        dto.setInternalType(ContractInternalType.OPERATIONAL);
        this.dto = dto;
    ...
    private void initComponent() {
        ...
        List<SubjectDto> ourCompanies = componentOperation.getOurCompCustomerList();
        ...
        connectedContract.setItems(filterContractBySubject(contractParty.getValue()));
        ...
        if (subjectDto != null) {
            for (ContractDto contract : contractList) {
                if (contract.getContractParty() != null
                        && contract.getContractParty().getId().equals(subjectDto.getId())
                        && contract.getInternalType() == ContractInternalType.OPERATIONAL) {
