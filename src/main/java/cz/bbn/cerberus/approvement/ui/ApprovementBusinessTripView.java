...
@Route(value = ApprovementBusinessTripView.ROUTE, layout = MainLayout.class)
@Authorize(Permission.APPROVEMENT_BUSINESS_TRIP_VIEW)
public class ApprovementBusinessTripView extends AppView implements HasUrlParameter<String> {

    public static final String ROUTE = "approvement-business-trip-list";
    ...
    public ApprovementBusinessTripView(AppEnv appEnv, ApprovementComponentOperation approvementComponentOperation,
                                       EntityNewComponentOperation entityNewComponentOperation,
                                       ListService listService, HolidayService holidayService, RoleService roleService,
    ...
    private void initView(String params) {
        ...
        approvementCardComponent = new ApprovementCardComponent(appEnv, approvementComponentOperation,
                ...
                ApprovementType.BUSSINES_TRIP, params, Permission.APPROVEMENT_BUSINESS_TRIP_VIEW, roleService, ROUTE,
