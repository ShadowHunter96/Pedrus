...
@Route(value = ApprovementHolidayView.ROUTE, layout = MainLayout.class)
@Authorize(Permission.APPROVEMENT_HOLIDAY_VIEW)
public class ApprovementHolidayView extends AppView implements HasUrlParameter<String> {
    public static final String ROUTE = "approvement-holiday-list";
    ...
    public ApprovementHolidayView(AppEnv appEnv, ApprovementComponentOperation approvementComponentOperation,
    ...
    private void initView(String params) {
        ...
        approvementCardComponent = new ApprovementCardComponent(appEnv, approvementComponentOperation,
                ...
                ApprovementType.HOLIDAY, params, Permission.APPROVEMENT_HOLIDAY_VIEW, roleService, ROUTE,
