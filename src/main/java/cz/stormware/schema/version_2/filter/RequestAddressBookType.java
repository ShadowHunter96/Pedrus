 ...
 *       &lt;sequence&gt;
 *         &lt;element name="filter" type="{http://www.stormware.cz/schema/version_2/filter.xsd}filterAdbsType" minOccurs="0"/&gt;
...
@XmlSeeAlso({
    RequestAddressBookActionType.class
})
public class RequestAddressBookType {

    protected FilterAdbsType filter;
     ...
     *     
     */
    public FilterAdbsType getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(FilterAdbsType value) {
        this.filter = value;
    }
