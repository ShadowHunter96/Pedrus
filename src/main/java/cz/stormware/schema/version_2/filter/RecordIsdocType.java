...
/**
 * <p>Java class for recordIsdocType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="recordIsdocType"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;/all&gt;
 *       &lt;attribute name="agenda" use="required" type="{http://www.stormware.cz/schema/version_2/filter.xsd}isdocAgendaType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "recordIsdocType", propOrder = {

})
public class RecordIsdocType {

    protected FilterIDType filter;
    protected String userFilterName;
    @XmlAttribute(name = "agenda", required = true)
    protected IsdocAgendaType agenda;
     ...
     * @return
     *     possible object is
     *     {@link IsdocAgendaType }
     *     
     */
    public IsdocAgendaType getAgenda() {
        return agenda;
    }
     ...
     *     
     */
    public void setAgenda(IsdocAgendaType value) {
        this.agenda = value;
    }
