 ...
 *       &lt;sequence&gt;
 *         &lt;element name="filter" type="{http://www.stormware.cz/schema/version_2/filter.xsd}filterStocksType" minOccurs="0"/&gt;
...
@XmlSeeAlso({
    RequestStockActionType.class
})
public class RequestStockType {

    protected FilterStocksType filter;
     ...
     * @return
     *     possible object is
     *     {@link FilterStocksType }
     *     
     */
    public FilterStocksType getFilter() {
        return filter;
    }
     ...
     *     
     */
    public void setFilter(FilterStocksType value) {
        this.filter = value;
    }
