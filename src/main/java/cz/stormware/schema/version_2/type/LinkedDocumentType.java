 ...
 *         &lt;element name="sourceDocumentItem" type="{http://www.stormware.cz/schema/version_2/type.xsd}sourceDocumentItemType" minOccurs="0"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class LinkedDocumentType {
    ...
    protected SourceDocumentItemType sourceDocumentItem;
    ...
    /**
     * Gets the value of the sourceDocumentItem property.
     * 
     * @return
     *     possible object is
     *     {@link SourceDocumentItemType }
     *     
     */
    public SourceDocumentItemType getSourceDocumentItem() {
        return sourceDocumentItem;
    }

    /**
     * Sets the value of the sourceDocumentItem property.
     * 
     * @param value
     *     allowed object is
     *     {@link SourceDocumentItemType }
     *     
     */
    public void setSourceDocumentItem(SourceDocumentItemType value) {
        this.sourceDocumentItem = value;
    }
