 ...
 *       &lt;/all&gt;
 *       &lt;attribute name="actionType" type="{http://www.stormware.cz/schema/version_2/type.xsd}attributeActionType" default="add" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class LabelType {
    ...
    protected AttributeActionType actionType;
     ...
     * @return
     *     possible object is
     *     {@link AttributeActionType }
     *     
     */
    public AttributeActionType getActionType() {
        if (actionType == null) {
            return AttributeActionType.ADD;
        } else {
            return actionType;
        }
    }
     ...
     *     
     */
    public void setActionType(AttributeActionType value) {
